...
const bgm = PIXI.sound.Sound.from({
    url: 'assets/sounds/sunrise-114326.mp3',
    autoPlay: true,
    complete: function() {
        bgm.play();
    }
...
const accept = PIXI.sound.Sound.from({
    url: 'assets/sounds/tribe-drum-loop-103173.mp3',
});

const finish = PIXI.sound.Sound.from({
    url: 'assets/sounds/bang-140381.mp3'
});
...
function setup() {
    ...
    title = new PIXI.Text('Rush & Move!', style);
...
function gameOver(player) {
    title.text = player + ' tu to jeet gya re!'; 
    title.visible = true;
    hint.visible = true;
    player1.visible = false;
    player2.visible = false;
